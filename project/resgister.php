...
<head>
    ...
    <meta name="description" content="PHP Book Store ">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h1 style="color:white">PHP BOOK STORE</h1>
                    <!-- <a href="index.html">
                ...
                <div class="login-form">
                    <form method="post" action="actions/register_action.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="contact" placeholder="User Contact No">
                        </div>
                                    <div class="checkbox">
                                        <label>
